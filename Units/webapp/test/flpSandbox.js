		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Basics",
									"targetURL": "#samplebasics-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"samplebasics-display": {
								"semanticObject": "samplebasics",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=samplebasics",
									"url": sap.ui.require.toUrl("samplebasics")
								}
							}
						}
					}
